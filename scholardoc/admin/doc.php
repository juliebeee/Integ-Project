...
<body>
  ...
  <!-- Year Selection Buttons -->
<div class="year-buttons">
  <button class="year-button active" onclick="loadData('2nd')">2nd Year</button>
...
function handleFileChange(input, rowId) {
 ...
 <script>
    ...
    if (year === '2nd') {
      // Make an AJAX request or handle data loading for 2nd year
    } else if (year === '3rd') {
